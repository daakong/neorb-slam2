...
//    cout << "Vocabulary loaded!" << endl << endl; // old cout
    ...
    cv::Mat System::neoTrackStereo(const int ni, const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp,
                                   const cv::Mat &im_last, const cv::Mat &depth_last, cv::Mat & last_key_imGray)
    {
        ...
        cv::Mat Tcw = mpTracker->GrabImageStereo(ni,imLeft,imRight,timestamp, im_last,depth_last,last_key_imGray);
